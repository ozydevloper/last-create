...
export const Detail = () => {
  return (
    <div className="fixed inset-0 bg-black/50 z-50 h-dvh flex justify-center p-2 overflow-y-scroll">
      <CardParent className="h-fit flex flex-col gap-y-2 bg-primary-foreground">
        <Badge
          color="red"
          className="flex items-center justify-center sticky top-0 active:bg-red-200"
        >
          <ArrowUp size={15} />
        </Badge>
        ...
        <CardParent className="gap-y-1">
          ...
          <CardParent className="mt-5 gap-y-2">
            ...
            <div className="flex flex-col gap-y-0.5">
              <div className="w-full flex items-start text-start justify-start gap-x-1">
                ...
                <p className="text-xs font-normal">Jumat, 08 September 2007</p>
              </div>
              <div className="w-full flex items-start text-start justify-start gap-x-1">
                <CardSubTitle className="font-bold text-xs">
                  Waktu:
          ...
          <CardParent>
            <CardSubTitle className="w-full text-center text-xs font-bold">
              Pelaksanaan
            </CardSubTitle>
          </CardParent>
        </CardParent>
